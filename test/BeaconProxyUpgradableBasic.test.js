...
contract('ProductBeaconProxy', function (accounts) {
    ...
    xit('non-contract beacon', async function () {
      await expectRevert(BeaconProxy.new('0x27dFE2F4aDf590a2B279C8B38E6552cC857B8396', '0x'),'BeaconProxy: beacon is not a contract',);
    });

    xit('non-compliant beacon', async function () {
    ...
    xit('non-contract implementation', async function () {
